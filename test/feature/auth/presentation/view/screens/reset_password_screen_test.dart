...
void main() {
  ...
  group("ResetPasswordScreen Tests", () {
    testWidgets("Verify AppBar exists", (WidgetTester tester) async {
      ...
      expect(find.byKey(const Key(AppWidgetsKeys.resetPasswordAppBar)), findsOneWidget);
    ...
    testWidgets("Verify Title and Subtitle", (WidgetTester tester) async {
      ...
      expect(find.byKey(const Key(AppWidgetsKeys.resetPasswordTitle)), findsOneWidget);
      expect(find.byKey(const Key(AppWidgetsKeys.resetPasswordSubtitle)), findsOneWidget);
    });

    testWidgets("Verify Password and Confirm Password TextFields exist", (WidgetTester tester) async {
      await tester.pumpWidget(prepareWidget());

      final newPasswordField = find.byKey(const Key(AppWidgetsKeys.newPasswordTextField));
      final confirmPasswordField = find.byKey(const Key(AppWidgetsKeys.confirmPasswordTextField));
    ...
    testWidgets("Verify Confirm Button exists", (WidgetTester tester) async {
      ...
      final confirmBtn = find.byKey(const Key(AppWidgetsKeys.resetPasswordConfirmButton));
    ...
    testWidgets("Verify Loading State", (WidgetTester tester) async {
      ...
      expect(find.byKey(const Key(AppWidgetsKeys.resetPasswordConfirmButton)), findsNothing);
    });
    ...
    testWidgets("Show error when password fields are empty", (WidgetTester tester) async {
      await tester.pumpWidget(prepareWidget());

      await tester.tap(find.byKey(const Key(AppWidgetsKeys.resetPasswordConfirmButton)));
      await tester.pumpAndSettle();
    ...
    testWidgets("Show error when passwords do not match", (WidgetTester tester) async {
      await tester.pumpWidget(prepareWidget());
      ...
      expect(find.text("same password"), findsOneWidget); // Updated to match Validator
    });

    testWidgets("Show error when password is invalid", (WidgetTester tester) async {
      await tester.pumpWidget(prepareWidget());
      ...
      expect(find.text("Password must be at least 6 characters"), findsOneWidget); // Updated
    });

    testWidgets("Trigger ResetPasswordEvent when passwords are valid", (WidgetTester tester) async {
      ...
      verify(mockForgetPasswordBloc.add(
        argThat(isA<ResetPasswordEvent>()
