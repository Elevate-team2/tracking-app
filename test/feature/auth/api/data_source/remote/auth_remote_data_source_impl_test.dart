...
group("Login Tests", (){
  ...
  test("return SuccessResult when call api and success", ()async{
    when(mockAuthApiServices.login(request)).thenAnswer((_)
  ...
  test("return FailedResult when call api and failed on dioException", ()async{
  ...
  test("return FailedResult when call api and failed on Exception", ()async{
